...
Project-specific governance for the **Entities** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
